...
public class insertnewresult extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
           ...
           if(rs.next()){
           st.execute("insert into result values ('"+rollno+"','"+physicsmarks+"','"+chemistrymarks+"','"+mathsmarks+"','"+dbmsmarks+"','"+osmarks+"')");
           JOptionPane.showMessageDialog(null, "Successhully inserted student marks");
           setVisible(false);
           new insertnewresult().setVisible(true);
           }
           else{
               JOptionPane.showMessageDialog(null, "rollno is wrong");
           }
        }
        catch(Exception e){
